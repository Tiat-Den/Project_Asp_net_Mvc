...
namespace Bai_Cuoi_Ky.Controllers 
{
    ...
    List<string> price = null, string sort = null, int page = 1) 
     ...
     List<string> material = null, List<string> price = null, string sort = null, int page = 1) // Thêm tham số page
        {
    ...
    List<string> material = null, List<string> price = null, string sort = null, int page = 1) 
        {
            var products = _context.Products
                .Include(p => p.Category)
